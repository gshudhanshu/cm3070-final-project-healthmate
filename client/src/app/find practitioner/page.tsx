      ...
      <div className="py-8">
        ...
        <div className="flex gap-8">
          ...
          <aside className="mb-6 hidden w-full max-w-48 md:block">
            ...
            <Accordion
              type="multiple"
              value={["Availability", "Price", "Experience"]}
            >
              {filters.map((filter) => (
                <AccordionItem key={filter.name} value={filter.name}>
                  <AccordionTrigger className="test hover:no-underline">
                    {filter.name}
                  </AccordionTrigger>
              ...
              <div className="rounded-md bg-white p-4 shadow">
                <div className="flex flex-col items-start justify-between gap-6 md:flex-row">
                  ...
                  <div className="flex max-w-20 flex-col items-center justify-center gap-2">
                    <div className="flex h-20 w-20 rounded-lg bg-primary">
                      {/* <Image
                        src={"/next.svg"}
                        height={50}
                        width={50}
                    ...
                    <div className="mt-4 flex flex-col flex-wrap justify-between gap-4 md:flex-row md:items-center">
                      <div className="flex flex-col gap-2 md:flex-row md:items-center">
                        ...
                        <div className="flex grow flex-wrap gap-2">
                          ...
                          <span className="rounded-sm bg-secondary p-1 font-semibold">
                            10
                          </span>
                        </div>
                      </div>
